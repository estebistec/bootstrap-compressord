# Django settings for bootstrap_compressord project.
...
SECRET_KEY = 'kt+!1t7a6ud(jf&amp;t+*bsti7c0s$ba3vh!9g$&amp;vv+wkdtd3(!^p'
...
ROOT_URLCONF = 'bootstrap_compressord.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bootstrap_compressord.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "bootstrap_compressord.context_processors.google_analytics_key",
)
